...
from zojax.personal.friendconnect.interfaces import _


class IPersonalFriendConnectPortletManager(IPortletManagerConfiguration):
...
class IPersonalFriendConnectPortlet(interface.Interface):
